            ...
            <div className="container-principal">
                ...
                <div className="container-presentation-perso">
                    <div className="container-text-propos">
                      <p>Je suis un jeune développeur front-end français de 23 ans en reconversion professionnelle.<br/><br/>Suite à des études dans le génie-climatique puis dans le commerce, j'ai travaillé plusieurs années dans l'entreprise familiale en tant que gérant de magasin. <br/> J'ai ensuite découvert le monde de l'informatique et du développement web qui m'a tout de suite passionné.<br/><br/> Aujourd'hui je passe tout mon temps libre à créer des sites, des minis-jeux ou à suivre des formations sur différentes plateformes. Je suis un grand autodidacte, constamment entrain d'apprendre et de pratiquer, j'aspire à devenir développeur fullstack prochainement.<br/><br/>Je suis ouvert à toutes propositions, en espérant que mon profil vous plaise.</p>
                    </div>
